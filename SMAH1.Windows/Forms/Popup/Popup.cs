...
/********************************************************************************
    Article: Simple Popup Control
    Source: https://www.codeproject.com/Articles/17502/Simple-Popup-Control
    Author: Lukasz Swiatkowski
    License: The GNU Lesser General Public License (LGPLv3)
********************************************************************************/

namespace SMAH1.Forms.Popup
{
    /// <summary>
    /// 
    /// </summary>
    [ToolboxItem(false)]
    public partial class PopupComponent : ToolStripDropDown
    {
        ...
        private PopupComponent _ownerPopup;
        private PopupComponent _childPopup;
        ...
        public PopupComponent(Control content)
        {
        ...
        public void Show(Rectangle area)
        {
            ...
            Point location = new Point(area.Left, area.Top);
        ...
        private void SetOwnerItem(Control control)
        {
            ...
            if (control is PopupComponent)
            {
                PopupComponent popupControl = control as PopupComponent;
        ...
        private bool InternalProcessResizing(ref Message m, bool contentControl)
        {
            ...
            if (m.Msg == NativeMethods.WM_NCHITSMAH1UI)
            {
